...
import { MessageUploadForThankYou } from "../../../../../components/messageUpload/MessageUploadForThankYou";
    ...
    <>
      ...
      {isThankYouNode && !hideItemStyle &&
        localStore.ivrCampFlowData.flow.languageChange.map((lang) => (
          <MessageUploadForThankYou lang={lang} hideItemStyle={hideItemStyle} localStore={localStore} handleThankYouMsg={handleThankYouMsg} languageNames={languageNames} />
        ))}
    </>
  );
};
